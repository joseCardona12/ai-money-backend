...
export class OnboardingController {
  ...
  public static async createOnboarding(
    ...
    try {
      const { currency_id, monthly_income, initial_balance, goal_type_id, budget_preference_id } = req.body;
      ...
      if (initial_balance === undefined || typeof initial_balance !== "number") {
        res.status(400).json({
      ...
      const newOnboarding = await OnboardingService.createOnboarding(onboardingData);
  ...
  public static async updateOnboarding(
    ...
    try {
      ...
      const existingOnboarding = await OnboardingService.getOnboardingByUserId(userId);
  ...
  public static async completeOnboarding(
    ...
    try {
      ...
      const completedOnboarding = await OnboardingService.completeOnboarding(userId);
  ...
  public static async getOnboardingStatus(
    ...
    try {
      ...
      const isCompleted = await OnboardingService.isUserOnboardingCompleted(userId);
